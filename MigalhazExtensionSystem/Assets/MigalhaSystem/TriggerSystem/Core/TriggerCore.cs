...
namespace Trigger.Core
{
    ...
    public static class Vector2Extension
    {
        ...
        public static Vector3 DirectionFromAngle(this float angle, Vector3? rotationAxis = null, Vector3? startDirection = null)
        {
            rotationAxis ??= Vector3.forward;
            Quaternion myRotation = Quaternion.AngleAxis(angle, (Vector3)rotationAxis);
