...
//            bool isIn = Physics.CheckBox(position + m_TriggerOffset, m_TriggerSize, Quaternion.Euler(m_triggerRotation), m_TriggerLayerMask);
//            if (callbacks)
//            {
...
//                position = m_CenterObject.position;
//            }
//            Matrix4x4 rotationMatrix = Matrix4x4.TRS(position + m_TriggerOffset, Quaternion.Euler(m_triggerRotation), Vector3.one);
...
//            //bool isIn = cols.Length > 0;
//            bool isIn = Physics.CheckSphere(position + m_TriggerOffset, m_triggerRadius, m_TriggerLayerMask);
//            if (callbacks)
//            {
//                InvokeCallbacks(isIn);
//            }
