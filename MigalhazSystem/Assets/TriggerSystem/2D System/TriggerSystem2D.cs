...
namespace Trigger.System2D
{
    ...
    {
        #region Variables
        [SerializeField] Vector2 m_triggerSize = Vector2.one;
        ...
        public override bool InTrigger(Vector3 _position, bool callbacks = true)
        {
            ...
            bool isIn = Physics2D.OverlapBox(_position + TriggerOffset.ToVector3(), TriggerSize, m_triggerAngle, TriggerLayerMask);
            if (callbacks)
            {
        ...
        public override T InTrigger<T>(Vector3 _position, bool callbacks = true, bool _debugErrors = true)
        {
            ...
            GameObject g = Physics2D.OverlapBox(_position + TriggerOffset.ToVector3(), TriggerSize, m_triggerAngle, TriggerLayerMask).gameObject;
        ...
        public override T[] GetComponent<T>(Vector3 _position)
        {
            ...
            Collider2D[] colliders = Physics2D.OverlapBoxAll(_position + TriggerOffset.ToVector3(), TriggerSize, m_triggerAngle, TriggerLayerMask);
